...
related: ["[[how-neural-networks-train.fr]]", "[[transformer-architecture.fr]]", "[[recurrent-networks-and-lstm.fr]]", "[[reinforcement-learning.fr]]", "[[world-models.fr]]"]
---
...
Pour Llama 3 70B : ~70 milliards de paramètres répartis sur des centaines de tenseurs, typiquement en FP16, parfois quantifiés à 8/4/3 bits. Voir [[llm-inference-optimization.fr]].
...
3. **Architecture** — le [[transformer-architecture.fr|Transformer]] (2017) a remplacé les RNN, débloquant l'entraînement parallélisable et la capture de dépendances longues.
