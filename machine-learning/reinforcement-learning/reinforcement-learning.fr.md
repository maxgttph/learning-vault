...
related: ["[[how-neural-networks-train.fr]]", "[[neural-networks-overview.fr]]", "[[transformer-architecture.fr]]", "[[recurrent-networks-and-lstm.fr]]", "[[world-models.fr]]"]
---
...
Le détail de ces trois phases côté *mécanique d'entraînement* vit dans [[how-neural-networks-train.fr]] ; cette fiche-ci se concentre sur *pourquoi* ce sont des paradigmes distincts.
