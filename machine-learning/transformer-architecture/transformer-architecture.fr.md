...
related: ["[[neural-networks-overview.fr]]", "[[how-neural-networks-train.fr]]", "[[attention-mechanism.fr]]", "[[embeddings-and-tokenization.fr]]", "[[llm-inference-optimization.fr]]", "[[normalization.fr]]", "[[bias.fr]]", "[[recurrent-networks-and-lstm.fr]]", "[[reinforcement-learning.fr]]", "[[world-models.fr]]", "[[distillation.fr]]", "[[mixture-of-experts.fr]]"]
---
...
Voir [[embeddings-and-tokenization.fr]] pour l'entrée et la sortie, et [[attention-mechanism.fr]] pour le cœur d'une couche.
...
- **Dépendances longues sans dégradation** — n'importe quel token peut regarder n'importe quel autre directement via [[attention-mechanism.fr|l'attention]], peu importe la distance.
