...
- Pourquoi le front froid avance-t-il plus vite que le front chaud (→ occlusion) ? Voir [[depressions-et-anticyclones]].
- Comment le jet-stream d'altitude « pilote » la naissance de ces fronts ? Voir [[jet-stream-et-ondes-de-rossby]].
